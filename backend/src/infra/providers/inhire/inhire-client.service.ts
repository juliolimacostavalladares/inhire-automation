...
export class InhireClientService {
  ...
  private isJobDetail(value: unknown): value is InhireJobDetail {
    ...
    return (
      ...
      (fields.logo === undefined || typeof fields.logo === "string") &&
      (fields.about === undefined || typeof fields.about === "string") &&
  ...
  private isTenantPage(value: unknown): value is InhireTenantPage {
    ...
    return (
      ...
      (candidate.about === undefined || typeof candidate.about === "string") &&
